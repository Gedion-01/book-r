...
import { calculateEarnings } from "@/actions/admin/calculate-earning";
...
export async function ThisMonthStatus({ userPayload }: ThisMonthStatusProps) {
  ...
  const earning = await calculateEarnings();
  console.log(earning, "my earning");

  return (
    <div className="col-span-2 lg:col-span-1 bg-white rounded shadow-md h-full w-full">
